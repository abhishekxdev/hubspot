                ...
                <section className="overflow-hidden">
                    <div className="py-12 sm:py-20 md:py-36">
                        ...
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-8 sm:mt-12 md:mt-20">
                            <div className="relative overflow-hidden border border-white/20 rounded-xl sm:rounded-2xl shadow-xl shadow-black/15 ring-1 ring-white/20 bg-white/80 backdrop-blur-sm">
                                <div className="p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 bg-white/60 backdrop-blur-sm">
                                    <div className="bg-gray-50/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 md:p-6 lg:p-8 border border-gray-200/50">
                                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-0">
                                            <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-800">CRM Dashboard Preview</h3>
                                            <div className="flex gap-2">
                                                <span className="px-2 sm:px-3 py-1 bg-green-100/80 text-green-700 rounded-full text-xs">Active</span>
                                                <span className="px-2 sm:px-3 py-1 bg-violet-100/80 text-violet-700 rounded-full text-xs">HubSpot Sync</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8">
                                            <div className="bg-white/80 backdrop-blur-sm p-2 sm:p-3 md:p-4 rounded-lg border border-gray-200/50">
                                        ...
                                        <div className="space-y-3 sm:space-y-4">
                                            ...
                                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                                                {/* Contact 1 */}
                                                <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50">
                                                    ...
                                                    <div className="text-right flex-shrink-0 ml-2">
                                                        <span className="px-2 py-1 bg-green-100/80 text-green-700 rounded-full text-xs whitespace-nowrap">Active Lead</span>
                                                ...
                                                <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50">
                                                    ...
                                                    <div className="text-right flex-shrink-0 ml-2">
                                                        <span className="px-2 py-1 bg-yellow-100/80 text-yellow-700 rounded-full text-xs whitespace-nowrap">In Progress</span>
                                                ...
                                                <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50">
                                                    ...
                                                    <div className="text-right flex-shrink-0 ml-2">
                                                        <span className="px-2 py-1 bg-blue-100/80 text-blue-700 rounded-full text-xs whitespace-nowrap">New Deal</span>
                                                ...
                                                <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50">
                                                    ...
                                                    <div className="text-right flex-shrink-0 ml-2">
                                                        <span className="px-2 py-1 bg-orange-100/80 text-orange-700 rounded-full text-xs whitespace-nowrap">Follow Up</span>
                                                ...
                                                <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50">
                                                    ...
                                                    <div className="text-right flex-shrink-0 ml-2">
                                                        <span className="px-2 py-1 bg-red-100/80 text-red-700 rounded-full text-xs whitespace-nowrap">Overdue</span>
                                                ...
                                                <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50">
                                                    ...
                                                    <div className="text-right flex-shrink-0 ml-2">
                                                        <span className="px-2 py-1 bg-purple-100/80 text-purple-700 rounded-full text-xs whitespace-nowrap">Proposal Sent</span>
                                        ...
                                        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200/50">
                                            ...
                                            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2 sm:gap-3">
                                                <button className="p-2 sm:p-3 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50 text-center hover:bg-gray-50/80 transition-colors">
