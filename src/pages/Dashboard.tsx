...
Please create a professional, clear, and polite invoice email that includes all the necessary information and payment instructions.`;
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: <BarChart className="size-5 text-violet-600" />,
      change: '+8%'
    },
    {
      title: 'Overdue',
      value: Math.floor(invoices.length * 0.1).toString(),
      icon: <AlertCircle className="size-5 text-violet-600" />,
      change: '-5%'
    }
  ];
      ...
      <div className="container py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            ...
            <Button className="bg-gradient-to-r from-violet-600 to-violet-600 text-white hover:from-violet-700 hover:to-violet-700">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          {stats.map((stat, index) => (
            <Card key={index} className="p-6 bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            <TabsTrigger value="generate" className="data-[state=active]:bg-violet-50">
              Generate Email
            </TabsTrigger>
            <TabsTrigger value="history" className="data-[state=active]:bg-violet-50">
              History
            </TabsTrigger>
            <TabsTrigger value="templates" className="data-[state=active]:bg-violet-50">
              Templates
            </TabsTrigger>
          </TabsList>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <Card className="p-6 bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                <CardHeader className="p-0 mb-4">
                  <CardTitle>Generate Invoice Email</CardTitle>
                  <CardDescription>Fill in the details to generate a professional invoice email</CardDescription>
                </CardHeader>
              ...
              <Card className="p-6 bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardDescription>Your generated invoice email will appear here</CardDescription>
                </CardHeader>
                <CardContent className="p-0">
                  {latestGeneratedEmail ? (
                    <div className="bg-gray-50 p-4 rounded-lg max-h-96 overflow-y-auto">
                      <pre className="text-sm whitespace-pre-wrap text-gray-700">{latestGeneratedEmail}</pre>
                    </div>
                  ) : (
                    <div className="bg-gray-50 p-8 rounded-lg text-center">
                      <Mail className="size-12 text-gray-400 mx-auto mb-3" />
                      <p className="text-gray-500">Generate an invoice email to see it here</p>
                    </div>
                  )}
                </CardContent>
              </Card>
          ...
          <TabsContent value="history" className="space-y-4">
            {invoices.length === 0 ? (
              <Card className="p-6 bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                <p className="text-center text-muted-foreground">No invoices generated yet. Create your first invoice!</p>
              </Card>
            ) : (
              invoices.map((invoice) => (
                <Card key={invoice.id} className="p-6 bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button 
                        variant="outline" 
                        size="icon" 
                        className="bg-white border-gray-200 text-red-600 hover:text-red-700"
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <pre className="text-sm whitespace-pre-wrap text-gray-700">{invoice.generatedEmail}</pre>
                  </div>
                </Card>
              ))
            )}
          ...
          <TabsContent value="templates" className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <Card key={index} className="p-6 bg-white border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                ...
                <Button 
                  variant="outline" 
                  className="mt-4 w-full bg-white border-gray-200"
                  onClick={() => {
